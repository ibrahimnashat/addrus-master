...
class Urls {
  ...
  static const String BASE_URL = "https://addrus.com/api/v3/"; //"http://addrus.com/api/v3/"; //"https://addrus.xyz/z/api/v3/" ;//"https://adrustesting.xyz/api/v2/";
  //-----
  ...
  static  String FORGET_PASSWORD = "${BASE_URL}password/create"; //forgotpassword";

  static const String HOME_SLIDER = "${BASE_URL}student/home"; //sliders";
  static const String CATEGORIES = "${BASE_URL}getcategories";
  static const String ALL_COURSES = "${BASE_URL}student/courses";  //enrollmentCourses";
